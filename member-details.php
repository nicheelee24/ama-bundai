    ...
    <div class="row">
      ...
      <form method="post" action="controllers/api.php?flag=createMem">
        <div class="card-body">
          ...
          <div class="form-group">
          <label  style="font-size:16px;font-weight:normal;"><?php if($uid!=""){if (isset($agntsArr[0]->promotionId)){  echo '<a>'.$agntsArr[0]->promotionId.'</a>'  ?> <?php }else{echo 'No Promotion Applied';}} ?></label>
          </div>
