          ...
          <tbody>
            ...
            foreach ($userStats as $usr) {
              ...
              ?>
                ...
                <td <?php if($usr["Status"]=="Blacklist"){ ?> style="font-weight:bolder" <?php }?><?php if($usr["Status"]=="Block"){ ?> style="color:red" <?php }?>><?php echo $usr["TotalDepositTimes"]; ?></td>
                <td <?php if($usr["Status"]=="Blacklist"){ ?> style="font-weight:bolder" <?php }?><?php if($usr["Status"]=="Block"){ ?> style="color:red" <?php }?>><?php echo $usr["TotalDepositAmount"]; ?></td>
                <td <?php if($usr["Status"]=="Blacklist"){ ?> style="font-weight:bolder" <?php }?><?php if($usr["Status"]=="Block"){ ?> style="color:red" <?php }?>><?php echo $usr["TotalWithdrawTimes"]; ?></td>
                <td <?php if($usr["Status"]=="Blacklist"){ ?> style="font-weight:bolder" <?php }?><?php if($usr["Status"]=="Block"){ ?> style="color:red" <?php }?>><?php echo $usr["TotalWithdrawAmount"]; ?></td>

                <td <?php if($usr["Status"]=="Blacklist"){ ?> style="font-weight:bolder" <?php }?><?php if($usr["Status"]=="Block"){ ?> style="color:red" <?php }?>>
                  <?php
