...
if($flag=='removeAppliedPromo')
{
  ...
  // die("..");
   ...
   $con = new MongoDB\Client("mongodb+srv://nicheelee24:3PeXZKHyKQQhaClJ@cluster0.8yb8idj.mongodb.net/gms2024?retryWrites=true&w=majority&appName=Cluster0&serverSelectionTryOnce=false&serverSelectionTimeoutMS=30");
...
if ($flag == 'login') {
   // echo "api page - database connection error";
    ...
    $mongo = new MongoDB\Driver\Manager("mongodb+srv://nicheelee24:3PeXZKHyKQQhaClJ@cluster0.8yb8idj.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0");
