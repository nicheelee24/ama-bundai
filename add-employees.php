    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <form method="post" <?php if ($uid == ""){?> action="controllers/api.php?flag=newEmp" <?php }else{ ?> action="controllers/api.php?flag=updEmp&id=<?php echo $uid;?>" <?php } ?>>
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control" required
                                        value="<?php if ($uid != ""){ echo $agntsArr[0]->agentname; 
                                                }?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="phone" class="form-control" required
                                        value="<?php if ($uid != ""){ echo $agntsArr[0]->phone; 
                                                }?>" placeholder="Phone">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="uname" class="form-control" required
                                        value="<?php if ($uid != ""){ echo $agntsArr[0]->userid; 
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="pass" class="form-control"
                                        value="<?php if ($uid != ""){ echo $agntsArr[0]->pwd; 
                                                }?>" required
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="manualLimit" class="form-control" required
                                        value="<?php if ($uid != ""){ echo $agntsArr[0]->manualLimit; 
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" onclick="checkUncheck(this)" type="checkbox" name="permissions[]" <?php if ($uid != "") if (in_array("viewEmp", $agntsArr[0]->permissions)) { ?> checked <?php } ?>
                                            value="viewEmp">
                                        <label class="form-check-label">View Employees</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" onclick="checkUncheck(this)" name="permissions[]" type="checkbox" <?php if ($uid != "") if (in_array("updEmp", $agntsArr[0]->permissions)) { ?> checked <?php } ?>
                                            value="updEmp">
                                        <label class="form-check-label">Update Employees</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" onclick="checkUncheck(this)" name="permissions[]" type="checkbox" <?php if ($uid != "") if (in_array("createEmp", $agntsArr[0]->permissions)) { ?> checked <?php } ?>
                                            value="createEmp">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" onclick="checkUncheck(this)" type="checkbox" name="permissions[]" value="memView" <?php if ($uid != "") if (in_array("memView", $agntsArr[0]->permissions)) { ?> checked <?php } ?>>
                                        <label class="form-check-label">View Member</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" onclick="checkUncheck(this)" type="checkbox" name="permissions[]" value="memUpdate" <?php if ($uid != "") if (in_array("memUpdate", $agntsArr[0]->permissions)) { ?> checked <?php } ?>>
                                        <label class="form-check-label">Update Member</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" onclick="checkUncheck(this)" name="permissions[]" type="checkbox" <?php if ($uid != "") if (in_array("createMem", $agntsArr[0]->permissions)) { ?> checked <?php } ?>
                                            value="createMem">
                        ...
                        <div class="card-footer">
                            <?php if($uid!=""){ ?>
                            <button type="submit" class="btn btn-primary" <?php if(isset($_SESSION["access"])){ if(!in_array('updEmp',$_SESSION["access"])){ ?> style="display:none" <?php }} ?> >Update</button>
                            <?php } else{?>
                           
                            <button type="submit" <?php if(isset($_SESSION["access"])){ if(!in_array('createEmp',$_SESSION["access"])){ ?> style="display:none" <?php }} ?> class="btn btn-primary" >Submit</button>
                            <?php } ?>
                        </div>
                </form>
            </div>
